        ...
        >
          <div className="space-y-12">
            <div className="border-b border-gray-700/10 pb-12">
              <h2 className="font-semibold leading-7 text-gray-700 text-3xl">
                ADD NEW PROJECT
              </h2>
                ...
                <div className="w-full sm:col-span-4">
                  ...
                  <div className="mt-2">
                    <div className="relative flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 ">
                      <input
                        type="text"
                        className="block flex-1 border-0 bg-transparent py-1.5 pl-8 text-gray-700 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
