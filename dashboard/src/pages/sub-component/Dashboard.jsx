...
import { clearAllSkillErrors, getAllSkills } from "@/store/slice/addSkillSlice";
import {
  clearAllSoftwareAppErrors,
  deleteSoftwareApplication,
  getAllSoftwareApplications,
  resetSoftwareApplicationSlice,
} from "@/store/slice/softwareApplicationSlice";
...
import {
  ...
  getAllTimeline,
} from "@/store/slice/timelineSlice";
import {
                              ...
                              <TableRow className="bg-accent" key={element._id}>
                                ...
                                <TableCell className="md:table-cell">
                                  <img
                                    className="w-9 h-9"
                                    src={
                                      element?.svgImg && element?.svgImg?.url
                                    }
                                    alt={element?.name}
                                  />
                                </TableCell>
