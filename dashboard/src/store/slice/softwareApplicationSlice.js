...
export const getAllSoftwareApplications = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://my-protfolio-ghj2.onrender.com/api/v1/software/getSoftware",
...
export const addNewSoftwareApplication = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://my-protfolio-ghj2.onrender.com/api/v1/software/add",
      data,
      {
        withCredentials: true,
...
export const deleteSoftwareApplication = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://my-protfolio-ghj2.onrender.com/api/v1/software/delete/${id}`,
      {
        withCredentials: true,
      }
    );
